object SpecView: TSpecView
  Left = 0
  Top = 0
  Caption = 'MS spectrum view'
  ClientHeight = 845
  ClientWidth = 1461
  Color = clBtnFace
  ...
  object RightPanel: TAdvPanel
    ...
    object RightPageCtrl: TAdvPageControl
      ...
      object DeNovoTab: TAdvTabSheet
        ...
        object DeNovoChk: TAdvOfficeCheckBox
          Left = 3
          Top = 3
          Width = 88
          Height = 20
          Hint = 'Enable sequence tag / de novo'
          ShowHint = True
          TabOrder = 4
          OnClick = DeNovoChkClick
          Alignment = taLeftJustify
          Caption = 'Sequence tag'
          ReturnIsTab = False
          Version = '1.8.0.5'
        end
        ...
        object ColorPeaksChk: TAdvOfficeCheckBox
          Left = 2
          Top = 138
          Width = 120
          Height = 20
          TabOrder = 8
          OnClick = ColorPeaksChkClick
          Alignment = taLeftJustify
          Caption = 'Color peaks'
          ReturnIsTab = False
          Version = '1.8.0.5'
        ...
        object ShowAAdistChk: TAdvOfficeCheckBox
          Left = 2
          Top = 164
          Width = 120
          Height = 20
